    ...
    public struct XRILeftHandActions
    {
        ...
        public void SetCallbacks(IXRILeftHandActions instance)
        {
            if (m_Wrapper.m_XRILeftHandActionsCallbackInterface != null)
            {
                ...
                @Pause.started -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnPause;
                @Pause.performed -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnPause;
                @Pause.canceled -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnPause;
                @TimeSlow.started -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnTimeSlow;
                @TimeSlow.performed -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnTimeSlow;
                @TimeSlow.canceled -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnTimeSlow;
                @SpeedTimeUp.started -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnSpeedTimeUp;
                @SpeedTimeUp.performed -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnSpeedTimeUp;
                @SpeedTimeUp.canceled -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnSpeedTimeUp;
            }
    ...
    public struct XRIRightHandActions
    {
        ...
        public void SetCallbacks(IXRIRightHandActions instance)
        {
            if (m_Wrapper.m_XRIRightHandActionsCallbackInterface != null)
            {
                ...
                @Pause.started -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnPause;
                @Pause.performed -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnPause;
                @Pause.canceled -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnPause;
